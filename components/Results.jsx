      ...
      <div className="grid grid-cols-1 gap-6">
        {results?.map((result, index) => (
          <div key={result.id} className="bg-black/50 rounded-md p-6 text-white">
            ...
            {/* View button */}
            <div className="w-fit mt-6 bg-black p-2 sm:p-4 border border-[#ACC156] rounded-md font-press-start-2p text-xs flex items-center gap-2"> View <FaChevronRight className="h-4 w-4" /></div>
          </div>
        ))}
      </div>
